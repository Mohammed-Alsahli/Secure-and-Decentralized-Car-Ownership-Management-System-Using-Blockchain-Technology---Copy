...
const Verify = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const response = await verifyByGoverment({
      vin,
      owner_name,
      price_bought,
      accident_involvement,
    ...
    <>
      <div className="text-center">
        ...
        <div className="  md:w-[80%] w-[100%] mx-auto ">
          ...
          <form
            className="flex flex-col gap-8 justify-center items-center mx-auto"
            ...
            <button
              disabled={loading}
              to="/viewgovermentside"
              type="submit" className="bg-[#BDAEE8] md:text-[30px] text-[22px] col-span-1 py-4 font-semibold hover:bg-[#9584c4] transition-all ease-in-out delay-150 rounded-[30px] w-[35%] text-[#fff]" >
        ...
        <Link
          to="/viewgovermentside"
          type="button" className="previous-button bg-[#606060] p-4 rounded-[15px] md:text-[30px] text-[20px]"
        >
          Previous
        </Link>
      </div>
